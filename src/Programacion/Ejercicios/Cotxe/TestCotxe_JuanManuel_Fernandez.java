package Programacion.Ejercicios.Cotxe;/*
...
public class TestCotxe_JuanManuel_Fernandez {
    public static void main(String[] args) {
        ...
        //-------PARTE 2
        /*CotxeSegonaPart_JuanManuel_Fernandez c2 = new CotxeSegonaPart_JuanManuel_Fernandez("Ford", "Focus RS", TipusCanvi.CanviManual, EstatsMotorCotxe.Aturat, Cinturo.NoFermat);
        try {
            c2.arrancarMotor();
