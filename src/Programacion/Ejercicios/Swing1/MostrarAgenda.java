package Programacion.Ejercicios.Swing1;
...
public class MostrarAgenda extends JFrame{
    ...
    public MostrarAgenda()
    {
        ...
        borrarButton = new JButton("Delete this Entry");
        actualizarButton = new JButton("Update this Entry");
        ...
        add(borrarButton);
        //actualizar
        actualizarButton.addActionListener(
                new ActionListener()
                {
                    public void actionPerformed(ActionEvent evt)
                    {
